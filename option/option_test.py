...
# Data specifications
parser.add_argument('--data_dir', type=str, default='/home/csu529/project/dataset',
...
# pca settings
parser.add_argument('--pca_path', type=str, default='/home/csu529/project/CATA/pca/pca_matrix_x4.pth',
                    help='pca path')
...
parser.add_argument('--project_path', type=str, default='/home/csu529/project/CATA',
                    help='project path')
